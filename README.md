...
1. Download the [update site](https://github.com/csabimf/awm-git/releases/latest/download/awm_git.zip) from the [latest release](https://github.com/csabimf/awm-git/releases/latest).
