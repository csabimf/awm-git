...
import com.microfocus.awmplugins.git.commands.builder.AddBuilder;
import com.microfocus.awmplugins.git.commands.builder.Git;

public class AddExecutor implements IToolExecutor2 {

    private static final String TOOL_ID = PluginConstants.FUNCTION_PACKAGE_ID + ".add";
    ...
    public IToolResult executeSingleProcessing(final IToolContext toolContext, final IProgressMonitor progressMonitor) throws TaurusToolException {
        ...
        final AddBuilder builder = Git.repo(repository).add();
        ...
        final GitAdd command = builder.prepare();
