...
import com.microfocus.awmplugins.git.commands.builder.BranchBuilder;
import com.microfocus.awmplugins.git.commands.builder.Git;

public class BranchCreateExecutor implements IToolExecutor2 {

    private static final String TOOL_ID = PluginConstants.FUNCTION_PACKAGE_ID + ".branchCreate";
    ...
    public IToolResult executeSingleProcessing(final IToolContext toolContext, final IProgressMonitor progressMonitor) throws TaurusToolException {
        ...
        final BranchBuilder builder = Git.repo(repository).branch().param(name);
        ...
        final GitBranch command = builder.prepare();
