...
import com.microfocus.awmplugins.git.commands.builder.CheckoutBuilder;
import com.microfocus.awmplugins.git.commands.builder.Git;

public class CheckoutExecutor implements IToolExecutor2 {

    private static final String TOOL_ID = PluginConstants.FUNCTION_PACKAGE_ID + ".checkout";
    ...
    public IToolResult executeSingleProcessing(final IToolContext toolContext, final IProgressMonitor progressMonitor) throws TaurusToolException {
        ...
        final CheckoutBuilder builder = Git.repo(repository).checkout();
        ...
        final GitCheckout command = builder.prepare();
