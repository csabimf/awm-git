...
import com.microfocus.awmplugins.git.commands.builder.PullBuilder;

public class PullExecutor implements IToolExecutor2 {

    private static final String TOOL_ID = PluginConstants.FUNCTION_PACKAGE_ID + ".pull";
    ...
    public IToolResult executeSingleProcessing(final IToolContext toolContext, final IProgressMonitor progressMonitor) throws TaurusToolException {
        ...
        final PullBuilder builder = Git.repo(repository).pull();
        ...
        final GitPull command = builder.prepare();
